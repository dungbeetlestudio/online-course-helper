...
def run(dv,cf):
    ...
    try:
        ...
        dv(text=u"清除数据").click() # click x2
        dv(text=u"清除数据").click()
        dv(text=u"全部随机").click()
        dv(text=u"保存配置").click()
        ...
        while True:
            ...
            if g or h or o:
                ...
                if swipe_retry is 0: return False
                try:
                    print('screenshot')
                    img = dv.screenshot()
